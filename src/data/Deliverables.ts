...
const deliverables: Deliverable[] = [
  {
    ...
    links: [
      {
        logo: LuMousePointerClick,
        link: 'https://www.buttrpaper.com',
        name: 'buttrpaper.com',
      },
      {
        logo: LuGithub,
        link: 'https://github.com/SpaceTesla/buttr',
        name: '/SpaceTesla/buttr',
      },
    ],
    description:
  ...
  },
  {
    ...
    links: [
      {
        logo: LuMousePointerClick,
        link: 'https://www.gimnis.com/',
        name: 'gimnis.com',
      },
      {
        logo: LuGithub,
        link: 'https://github.com/SpaceTesla/gimni',
        name: '/SpaceTesla/gimni',
      },
    ],
    description:
  ...
  },
  {
    ...
    links: [
      {
        logo: LuMousePointerClick,
        link: 'https://www.codeefforts.com/',
        name: 'codeefforts.com',
      },
      {
        logo: LuGithub,
        link: 'https://github.com/SpaceTesla/code-efforts',
        name: '/SpaceTesla/code-efforts',
      },
    ],
    description:
