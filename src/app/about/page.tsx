...
export const metadata: Metadata = {
  ...
  description:
    'Learn about Shivansh Karan, a Bangalore-based Full Stack Developer with 5+ years of coding experience, 2+ years of design experience, and 4x Hackathon winner. View skills, experience, and hackathon achievements.',
  keywords: [
    'About Shivansh Karan',
                ...
                <div className="flex h-full w-[80%] flex-col max-lg:w-[90%] max-md:w-full">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm leading-relaxed font-light tracking-wide">
                      ...
                      meets its doom). Whether I'm crafting a product from
                      scratch or jumping into an existing codebase, I enjoy{' '}
